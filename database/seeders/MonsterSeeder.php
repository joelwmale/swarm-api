...
class MonsterSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $attributes = Attribute::where('id', '<', 6)->get();
        ...
        foreach ($monsters as $monster) {
            ...
            if ($baseMonster) {
                ...
                Monster::create(array_merge($monster, ['attribute_id' => Attribute::where('id', 6)->first()->id]));
                ...
                $attribute = Attribute::where('id', substr($monster['id'], -1))->first();
                Monster::create(array_merge($monster, ['attribute_id' => $attribute->id]));
            }
        }
    }
